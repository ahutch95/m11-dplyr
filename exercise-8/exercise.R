...
pulitzer %>% mutate(total.prizes = Pulitzer.Prize.Winners.and.Finalists..2004.2014 + Pulitzer.Prize.Winners.and.Finalists..1990.2014 + Pulitzer.Prize.Winners.and.Finalists..1990.2003) %>% arrange(desc(total.prizes)) %>% first() %>% first()
...
pulitzer <- pulitzer %>% mutate(daily.change = Daily.Circulation..2004 - Daily.Circulation..2013)
